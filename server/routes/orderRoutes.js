...
const { sendOrderStatusWhatsApp, sendOrderConfirmationWhatsApp } = require('../services/whatsappService');
  ...
  try {
    ...
    try {
      ...
      if (order) {
        ...
        await sendOrderConfirmationWhatsApp({ ...order, telefono_contacto });
      }
    } catch (emailErr) {
